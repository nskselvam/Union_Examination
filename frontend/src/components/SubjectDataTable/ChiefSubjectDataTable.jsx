...
const ChiefSubjectDataTable = ({ data = [], isLoading = false, title = "Subject Information", evaId = null ,selectedRole = null, onDelete = null }) => {
 ...
 const [searchText, setSearchText] = useState('');
  ...
  const columns = useMemo(() => [
    ...
    {
      name: 'Examiner ID',
      selector: row => row.chief_examiner || row.chief_examiner || '0',
      sortable: true,
      width: '130px',
      center: true,
      cell: (row) => (
        <span style={{
          ...
          {row.chief_examiner || row.chief_examiner || '0'}
        </span>
      ),
    },
...
export default ChiefSubjectDataTable