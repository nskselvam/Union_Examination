...
const LogNavBar = ({data}) => {
  ...
  return (
    ...
    <Navbar expand="lg" className="gen-navbar gov-navbar premium-navbar" sticky="top" role="navigation" aria-label="Main navigation">
      <Container fluid>
        <Navbar.Brand as={Link} to={homeRoute} className="d-flex align-items-center gov-brand">
          ...
          <div className="brand-text-wrap">
            <span className="brand-text premium-brand-text">{navbarData.Name} {data}</span>
