...
import ValuationReviewRight from '../../../components/ValuationRight/ValuationReviewRight'
import { useGetValuationImageDataQuery } from '../../../redux-slice/valuationApiSlice'
import { useGetTableDataWhereMutation } from '../../../redux-slice/generalApiSlice'
import Modal from 'react-bootstrap/Modal';

const ReviewExaminer = () => {
  ...
  console.log(`Dashboard_Data from Redux:`, MonthYear);
...
useEffect(() => {
  if (finalPaperData?.subcode) {
    console.log('Triggering mutation with:', finalPaperData.subcode);
    getTableDataWhere({
...
console.log(`finalPaperData:`, finalPaperData);
console.log(`finalPaperData.subcode:`, finalPaperData?.subcode);
console.log(`tableData (full response):`, tableData);
console.log(`tableData.data (actual records):`, tableData?.data);
...
console.log(`Extracted subname:`, Dashboard_Data);

console.log(`Extracted subname:`, tableData?.data);
...
console.log(`ReviewExaminer received finalPaperData:`, finalPaperData.ImgCnt);
...
//console.log(`Initialized imageIndices:`, imageIndices);
...
console.log(`Displaying page ${displayPage} of ${totalPages} (imgNumber: ${imgNumber})`);
...
console.log(`Valuation image data for imgNumber ${imgNumber}:`, valuationImageData,imageError);
...
console.log(`Valuation image data:`, valuationImageData);
...
return (
  <>
    <ValuationTemplate
      ...
      rightComponent={<ValuationReviewRight reviewValuationData={reviewData} onViewImage={handleViewImage} basicData={basicData} />}
    >
